...
":: extcv ::\n\nExpand a TrueCrypt volume on the fly without reformatting\n\n\n\
...
space on the host drive or host device of the TrueCrypt volume.\n\n\
...
int AskVolumePassword (HWND hwndDlg, Password *password, char *titleStringId, BOOL enableMountOptions)
{
	int result;
